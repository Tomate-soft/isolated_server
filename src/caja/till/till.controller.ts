...
export class TillController {
  ...
  async findOne(@Param('id') id: string) {
    try {
      ...
      throw new NotFoundException('Ha ocurrido algo inesperado al buscar esta cuenta');
    }
  }
  ...
  async delete(@Param('id') id: string) {
    try {
      ...
      throw new NotFoundException('No se pudo eliminar debido a un error inesperado');
    }
  }
  ...
  async update(@Param('id') id: string, @Body() body: UpdateTillDto) {
    try {
      ...
      throw new NotFoundException('No se ha podido actualizar debido a un error inesperado');
    }
  }
}
