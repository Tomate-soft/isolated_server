...
export class DishesController {
  ...
  async findOne(@Param('id') id: string) {
    try {
      ...
      if (!dishesSelected)
        throw new NotFoundException('El complemento que intentas buscar no existe');
  ...
  async delete(@Param('id') id: string) {
    try {
      ...
      if (!dishesDeleted) throw new NotFoundException('No existe el complemento');
  ...
  async update(@Param('id') id: string, @Body() body: updateDishesDto) {
    try {
      ...
      if (!updatedDishes) throw new NotFoundException('No existe el complemento');
