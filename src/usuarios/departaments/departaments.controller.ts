...
export class DepartamentsController {
  ...
  async findAll() {
    try {
      ...
      if (!departamentsArray) {
        throw new NotFoundException('No se encontraron departaments disponibles');
      }
  ...
  async findOne(@Param('id') id: string) {
    try {
      ...
      throw new NotFoundException('No se encontro el departamento debido a un error inesperado');
    }
  }
  ...
  async delete(@Param('id') id: string) {
    try {
      ...
      throw new NotFoundException('Ha ocurrido un error inesperado, no se ha podido eliminar');
    }
  }
  ...
  async update(@Param('id') id: string, @Body() Body: updateDepartamentDto) {
    try {
      ...
      if (!updatedDepartament) {
        throw new NotFoundException('No se encontro el departament que deseas actualizar');
      }
