...
export class ProfilesController {
  ...
  async create(@Body() body: createProfileDto) {
    ...
    try {
      ...
      throw new NotFoundException('Ha ocurrido un error inesperado, no se ha podido crear');
    }
  }
  ...
  async delete(@Param('id') id: string) {
    try {
      ...
      if (!profileDeleted) {
        throw new NotFoundException('No se encuentra el perfil que intentas eliminar');
      }
  ...
  async update(@Param('id') id: string, @Body() body: updateProfileDto) {
    ...
    try {
      ...
      if (!updatedProfile) {
        throw new NotFoundException('No se ha encontrado el perfil que deseas actualizar');
      }
